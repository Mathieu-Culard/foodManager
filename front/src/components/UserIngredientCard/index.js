...
const UserIngredientCard = ({
  id, name, quantity, image, type, unity, changeQuantity, deleteIngredient, deleteRecipeIngredient , changeRecipeIngredientQuantity
}) => (
    <div className="user-ingredient-card">
      ...
      {type === 'stock' && <input type="number" value={quantity} className="user-ingredient-card__input" onChange={(e) => changeQuantity(id, e.target.value)} />}
